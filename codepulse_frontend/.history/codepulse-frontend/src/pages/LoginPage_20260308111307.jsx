        ...
        <div className="p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl"
          ...
          <div className="space-y-4">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-purple-500/50 focus:bg-white/8 transition-all text-sm"
                  />
                </div>
              </motion.div>
            )}
            ...
            <motion.button
              ...
              className="w-full py-3 rounded-xl font-semibold flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 transition-all shadow-lg shadow-purple-500/25 mt-2"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            {["GitHub", "Google"].map((provider) => (
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="py-2.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-gray-300 text-sm font-medium transition-all flex items-center justify-center gap-2"
              >
