      ...
      <div className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="bg-gradient-to-r from-cyan-400 via-indigo-400 to-green-400 bg-clip-text text-transparent">
              Mirror.
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-gray-400 text-lg mb-3 max-w-2xl mx-auto italic"
          >
            "Every line of code tells a story — we reveal the chapters you missed."
          </motion.p>
          ...
          <motion.p
            ...
            className="text-gray-600 text-sm mb-10 max-w-xl mx-auto"
          >
            Paste your code. Receive a productivity score, bug detection,
            complexity analysis, and intelligent suggestions — instantly.
          </motion.p>
          ...
          >
            <motion.button
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-xl text-lg font-semibold bg-gradient-to-r 
              from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 shadow-lg shadow-purple-500/25 transition-all"
            >
              <Code2 size={20} />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "Paste Your Code", desc: "Drop any code into our intelligent editor" },
              { step: "02", title: "Click Analyze", desc: "Our engine reads between the lines — literally" },
              { step: "03", title: "Get Results", desc: "Score, grade & a roadmap to cleaner code" },
            ].map((s, i) => (
              <div key={i} className="text-center">
        ...
        >
          ...
          <p className="text-gray-400 mb-6 italic text-sm">
            "Don't just write code. Write code that speaks."
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
