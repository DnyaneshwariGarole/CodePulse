        ...
        <div className="p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <motion.button
              ...
              className="py-2.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-gray-400 text-sm font-medium transition-all flex items-center justify-center gap-2 cursor-not-allowed opacity-60"
            >
              🌐 Google
            </motion.button>
          </div>
