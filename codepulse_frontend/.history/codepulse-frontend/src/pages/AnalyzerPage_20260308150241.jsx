...
import { Play, CheckCircle, AlertTriangle, XCircle, ChevronDown } from "lucide-react";
import API from "../api";
          ...
          <div className="space-y-4">
            {score ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-center p-10 rounded-2xl bg-white/5 border border-white/10 border-dashed min-h-[500px]">
                ...
                <p className="text-gray-500 text-sm">Paste your code on the left and click "Analyze"</p>
              </div>
            )}
          </div>
        </div>
